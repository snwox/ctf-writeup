...
print(time.time() - start, "deploy")

dd = re.compile(r"exploit ([0-9a-fA-Fx]{42})", re.MULTILINE)
exploit = dd.search(out).group(1)
#exploit = input("input exploit address:")
print(exploit)
env.update({"EXPLOIT":exploit})
for i in range(5):
    time.sleep(25)
    start = time.time()
    print("end")
